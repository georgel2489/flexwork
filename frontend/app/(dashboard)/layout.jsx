...
export default function Layout(props) {
  ...
  // }, [token, previousNotificationCount]);
  ...
  return (
    <DashboardLayout>
      {/* Floating Notification Icon with Badge - HIDDEN */}
      {/* <div
        style={{
          position: "absolute",
          top: "75px",
      ...
      {/* Snackbar to notify user of new notifications - HIDDEN */}
      {/* <Snackbar
      ...
      {/* Popover to show notification details - HIDDEN */}
      {/* <Popover
        open={isPopoverOpen}
        anchorEl={anchorEl}
        ...
        {notifications.length === 0 ? (
          ...
          notifications
            ...
            .map((notification) => (
              <ListItemButton
                key={notification.id}
                onClick={() => handleNotificationClickType(notification)}
                sx={{
                  backgroundColor:
